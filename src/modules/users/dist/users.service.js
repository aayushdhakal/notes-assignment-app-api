...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.deleteUser = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.destroy({ where: {
                                id: id
                            } })];
                    case 1:
                        count = _a.sent();
    ...
    UsersService.prototype.updateOne = function (id, updateInfo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.userRepository.update(updateInfo, { where: { id: id } });
                return [2 /*return*/];
            });
        });
    };
